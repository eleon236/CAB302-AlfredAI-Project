...
/**
 * Service class responsible for interacting with the Ollama AI API
 * to generate flashcards based on a given topic.
 */
public class OllamaService {

    /**
     * The URL for the Ollama API's generate endpoint.
     */
    private final String OLLAMA_URL = "http://localhost:11434/api/generate";
    /**
     * The name of the AI model to be used for generation (e.g., "llama3").
     */
    private final String MODEL = "llama3";

    /**
     * Generates a list of flashcards by sending a prompt to the Ollama AI.
     * The method constructs an HTTP request, sends it to the Ollama API,
     * parses the JSON response, and extracts the generated flashcards.
     *
     * @param topic The topic for which flashcards are to be generated.
     * @return A list of {@link Flashcard} objects generated by the AI, or {@code null} if an error occurs.
     * @throws Exception If an I/O error occurs during the HTTP request or response handling.
     */
